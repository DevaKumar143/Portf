...
const Service = ({ id }) => {
  const services = [
    { title: "Custom Website Design", description: "Tailor-made websites that reflect your brand identity and deliver a seamless user experience." },
    { title: "Responsive Web Design", description: "Mobile-friendly designs that adapt perfectly to smartphones, tablets, and desktops." },
    { title: "E-commerce Website Development", description: "Seamless online stores with payment integration, product management, and optimized for conversions." },
    { title: "Web App Development", description: "Interactive web apps built with React, Angular, and Vue.js — fast, scalable, and secure." },
    { title: "CMS Integration", description: "Flexible content management systems that allow you to manage your website easily and efficiently." },
    { title: "SEO & Performance Optimization", description: "Websites optimized for speed, SEO, and conversions to give your business an edge online." },
  ];
